...
export function FloatingNav() {
    ...
    return (
        <div suppressHydrationWarning className="fixed right-4 top-1/2 -translate-y-1/2 z-50 hidden lg:flex flex-col gap-6">
            <div suppressHydrationWarning className="flex flex-col gap-[12px] p-3 rounded-full bg-white/60 dark:bg-slate-950/50 backdrop-blur-2xl border border-border shadow-xl shadow-black/5 dark:shadow-black/20 relative">
                {}
                <div
