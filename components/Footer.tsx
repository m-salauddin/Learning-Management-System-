                        ...
                        <div className="flex items-center gap-4">
                            {SOCIAL_ICONS.map((Icon, i) => (
                                <a
                                    key={i}
                                    href="#"
                                    className="w-10 h-10 rounded-xl bg-white border border-slate-200 dark:bg-white/5 dark:border-white/5 flex items-center justify-center text-slate-500 dark:text-slate-400 hover:bg-primary hover:text-white hover:border-primary dark:hover:bg-primary dark:hover:text-white dark:hover:border-primary transition-all duration-300 cursor-pointer shadow-sm dark:shadow-none"
                            ...
                            <ul className="space-y-4">
                                {section.links.map((link) => (
                                    <li key={link.text}>
                                        <a
                                            href={link.href}
                                            className="group inline-flex items-center relative text-slate-500 dark:text-slate-400 hover:text-primary dark:hover:text-primary text-sm font-medium transition-colors cursor-pointer"
                                        >
