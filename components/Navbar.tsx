                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2 xl:gap-3">
                        ...
                        <div className="hidden min-[711px]:flex items-center gap-3">
                            <Link
                                href="/login"
                                className="flex items-center px-5 py-2.5 rounded-2xl text-sm font-bold text-foreground border border-border/50 bg-muted/50 hover:bg-muted/80 transition-all duration-200"
                            >
                                Login
                            </Link>
                            <Link
                                href="/register"
                                className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-primary text-primary-foreground font-medium text-sm hover:bg-primary/90 transition-all duration-200 shadow-lg"
                            >
                                Register
                    ...
                    <>
                        ...
                        >
                            ...
                            <div className="flex flex-col gap-3 pt-4 border-t border-border/50">
                                <Link
                                    href="/login"
                                    className="flex items-center justify-center px-5 py-3 rounded-xl text-sm font-bold text-foreground border border-border/50 bg-muted/50 hover:bg-muted/80 transition-all duration-200"
                                >
                                    Login
                                </Link>
                                <Link
                                    href="/register"
                                    className="flex items-center justify-center gap-2 px-5 py-3 rounded-xl bg-primary text-primary-foreground font-medium text-sm hover:bg-primary/90 transition-all duration-200 shadow-lg"
                                >
                                    Register
                                    <ArrowRight className="w-4 h-4" />
                                </Link>
