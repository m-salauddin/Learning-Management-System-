                        ...
                        >
                            ...
                            <div className="p-1 space-y-0.5">
                                {actions.map((action, idx) => {
                                    ...
                                    const showSeparator = action.separator || (idx === actions.length - 1 && actions.length > 1 && !actions[idx].separator && !actions.some(a => a.separator));
                                        ...
                                        <div key={idx}>
                                            ...
                                            <button
                                                ...
                                                className={cn(
                                                    ...
                                                    isDanger 
                                                        ? "hover:bg-rose-500/10 text-slate-350" 
                                            ...
                                            >
                                                <div className={cn(
                                                    ...
                                                    isDanger 
                                                        ? "bg-white/5 text-slate-500 group-hover:bg-rose-500/20 group-hover:text-rose-500" 
                                                ...
                                                <span className={cn(
                                                    ...
                                                    isDanger 
                                                        ? "text-slate-350 group-hover:text-rose-500" 
                                                        : "text-slate-350 group-hover:text-white"
                                                )}>
                                                    {action.label}
                                                </span>
                                                
                                                {}
                                                <div className="absolute inset-0 bg-linear-to-r from-white/0 via-white/5 to-white/0 opacity-0 group-hover:opacity-100 transition-opacity -translate-x-full group-hover:translate-x-full duration-1000 pointer-events-none" />
                                            </button>
                                        </div>
                                    );
                                })}
