...
export function AboutStatsSection() {
    ...
    const STATS: StatItem[] = [
        { icon: GraduationCap, value: 200, suffix: "+", label: t("expertCourses"), color: "primary" },
        { icon: Users, value: 50, suffix: "K+", label: t("activeLearners"), color: "secondary" },
        { icon: Briefcase, value: 95, suffix: "%", label: t("placementRate"), color: "success" },
        { icon: Star, value: 4.9, suffix: "", label: t("averageRating"), color: "warning", decimals: 1 },
    ];
